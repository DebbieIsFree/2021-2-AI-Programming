...
def conductExperiment(p, alg):
    ...
    if 5 <= aType <= 6:
        sumOfWhen = alg.getWhenBestFound()    # When the best solution is found
    ...
    avgMinimum = sumOfMinimum / numExp                     # value 평균
    avgNumEval = round(sumOfNumEval / numExp)              # eval 횟수 평균
    avgWhen = round(sumOfWhen / numExp)                    # When the best solution is found
